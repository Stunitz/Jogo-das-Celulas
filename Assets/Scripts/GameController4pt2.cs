...
public class GameController4pt2 : MonoBehaviour
{
    ...
    void Start()
    {
        spawnPoints = GameObject.FindGameObjectsWithTag("Spawn4");
        timeToSpawn = 3;
        currentTime2 = 0;
        currentTime = 0;
        EnemyBehaviourleft.speed = 3f;
    }
